...
const { data: topTracks, fetchMore, loading } = await usePaginatedFetch<Track>(
  ...
  <div v-if="data" p="x2 y3" lt-md:py-0 lt-md:px-3 overflow-hidden>
    <div absolute top-0 left-0 z-1 blur-2xl w-full h80 op20 lt-md:op40 overflow-hidden>
      <NuxtImg
        ...
        :src="data.picture_small" object-cover wfull hfull
      />
    </div>
    ...
    <div flex relative z-10 flex-col>
      <div flex flex-col items-center justify-center>
        <div
          ...
          overflow-hidden w-50 h-50 min-w-50 min-h-50
          class="lt-md:(h-40 w-40 min-h-40 min-w-40)"
        >
          <ImageBlurLoader
            v-if="data.picture_medium"
            :big-image-src="data.picture_medium"
        ...
        <div
          ...
          animate-duration-400 mt2
          flex="~ col" space="y3"
          items-center justify-center ml0 mt4
        >
          ...
          <div
            ...
            mt-8 ml-auto inline-flex h-min space-x-4
            justify-center
          >
    ...
    <div class="">
      <MusicContainer
        ...
        :navigate-back="true"
        title-class="ml3" mt15 lt-lg:mt10 title="Top Tracks"
      >
        <CardTrack
          v-for="(track, j) in topTracks"
          :key="j"
          :track="track"
          data-aos="fade-left"
